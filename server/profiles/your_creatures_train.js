...
const checkForOtherTraining = (fields) => new Promise((resolve, reject) => {
...
const checkForBreeding = (fields) => new Promise((resolve, reject) => {
	return !fields.creature.breeding ? resolve(fields) : reject({ msg: 'Can\'t train with a breeding creature', extra: '' });
});

const checkStatTotal = (fields) => new Promise((resolve, reject) => {
